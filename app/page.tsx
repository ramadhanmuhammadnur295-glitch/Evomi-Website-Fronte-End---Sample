...
const dict = {
  id: {
      ...
      cards: [
        {
          num: "01",
          label: "Seleksi",
          title: "Kurasi Bahan Premium",
          desc: "Mengekstrak elemen organik terbaik dari berbagai penjuru dunia untuk memastikan kemurnian dan konsistensi aroma di setiap tetesnya.",
        },
        {
          num: "02",
          label: "Alkimia",
          title: "Seni Keseimbangan Notes",
          desc: "Perpaduan presisi yang harmonis antara top, middle, dan base notes untuk menciptakan transisi wewangian yang halus dan memikat.",
        },
        {
          num: "03",
          label: "Resonansi",
          title: "Resonansi Karakter",
          desc: "Setiap racikan dirancang secara emosional untuk memperkuat impresi visual, meningkatkan kepercayaan diri, dan mengekspresikan aura unik Anda.",
        },
        {
          num: "04",
          label: "Ketahanan",
          title: "Jejak Kehadiran Abadi",
          desc: "Konsentrasi konsentrat yang tinggi menghasilkan tingkat sillage dan proyeksi prima, meninggalkan impresi mendalam bahkan setelah Anda berlalu.",
        },
      ],
    },
    ...
    signature: {
      title: "Esensi Khas",
      subtitle: "Koleksi Unggulan",
      btnHover: "Lihat Produk",
      ...
      slides: [
        {
          ...
          title: "EVOMI",
          desc: "Curating scents that transcend time.",
        },
        {
          tagline: "Every Version of Me",
          title: "ESSENCE",
          desc: "Discovering true self through every spray.",
        },
        {
          tagline: "Unisex & Long Lasting",
          title: "CRAFTED",
          desc: "Fragrance endurance up to 12 hours or more.",
        },
      ],
      ...
      cards: [
        {
          ...
          desc: "Extracting the best organic elements from around the world to ensure purity and consistency of aroma in every drop.",
        },
        {
          num: "02",
          label: "Alchemy",
          title: "The Art of Notes Balance",
          desc: "A harmonious precision blend between top, middle, and base notes to create a smooth and captivating fragrance transition.",
        },
        {
          num: "03",
          label: "Resonance",
          title: "Character Resonance",
          desc: "Every blend is emotionally designed to strengthen visual impression, boost confidence, and express your unique aura.",
        },
        {
          num: "04",
          label: "Longevity",
          title: "Eternal Presence Trail",
          desc: "High concentration of extracts produces prime sillage and projection levels, leaving a deep impression even after you have passed.",
        },
      ],
    },
    ...
    >
      ...
      <div className="min-h-screen bg-[#FBFBF9] dark:bg-stone-950 text-stone-900 dark:text-stone-100 font-sans antialiased transition-colors duration-300">
            ...
            {isMobileMenuOpen && (
              ...
              >
                <div className="px-8 py-10 flex flex-col space-y-8">
                  ...
                  <motion.div
                    variants={itemVars}
                    className="flex space-x-4 border-b border-white/20 pb-4"
                  >
                    <button
                      onClick={() => setLang("id")}
                      className={`text-sm font-bold uppercase tracking-widest ${lang === "id" ? "text-amber-400" : "text-white"}`}
                    >
                      ID
                    </button>
                    ...
                    <button
                      onClick={() => setLang("en")}
                      className={`text-sm font-bold uppercase tracking-widest ${lang === "en" ? "text-amber-400" : "text-white"}`}
                    >
                      EN
                    </button>
                  </motion.div>
                  ...
                  <div className="space-y-6">
                    {[
                      ...
                      { name: t.nav.collection, href: "#product" },
        ...
        >
          <motion.div
            style={{ y: heroBgY }}
            className="absolute inset-0 bg-gradient-to-b from-[#FBFBF9] via-stone-50 to-[#F5F5F0] dark:from-stone-950 dark:via-stone-900 dark:to-stone-950 opacity-80 scale-125 origin-top"
          />
          <motion.div
            style={{ y: heroTextY }}
          ...
          >
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className="space-y-6"
              >
                <p className="text-stone-400 dark:text-stone-500 tracking-[0.5em] uppercase text-xl font-semibold">
                  {t.hero.slides[currentSlide]?.tagline}
                </p>
                <h1
                  className={`${fontJudul.className} text-4xl md:text-[130px] uppercase text-stone-900 dark:text-stone-100 drop-shadow-sm`}
                >
                  {t.hero.slides[currentSlide]?.title}
                </h1>
                <p className="text-stone-500 dark:text-stone-400 italic max-w-xl mx-auto text-xl md:text-base">
            ...
            <div className="flex justify-center space-x-3 pt-8">
              {t.hero.slides.map((_, index) => (
                <button
                  ...
                  className={`h-1 transition-all duration-500 rounded-full ${currentSlide === index ? "w-8 bg-stone-900 dark:bg-stone-100" : "w-4 bg-stone-300 dark:bg-stone-700"}`}
                />
              ))}
            </div>
          </motion.div>
        ...
        <section
          id="about"
          className="relative py-24 md:py-32 bg-stone-950 text-white px-6 overflow-hidden z-20 w-full"
        >
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
              ...
              <div className="md:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
                {t.about.cards.map((card) => (
                  <div
                    key={card.num}
                    className="bg-white/[0.02] backdrop-blur-md border border-white/5 p-6 md:p-8 rounded-2xl space-y-4 hover:border-amber-500/20 transition-colors duration-300"
                  >
        ...
        <motion.section
          ...
          variants={fadeInUp}
          className="relative py-10 md:py-20 px-6 md:px-16 z-20 bg-[#FBFBF9] dark:bg-stone-950"
        >
          <div className="max-w-7xl mx-auto">
            ...
            >
              <h2
                className={`${fontJudul.className} text-3xl md:text-5xl uppercase tracking-tight text-stone-800 dark:text-stone-100`}
              >
                {t.carousel.title}
              </h2>
        ...
        <section
          id="product"
          className="relative py-20 md:py-32 px-4 md:px-8 bg-white dark:bg-stone-900 border-y border-stone-100 dark:border-stone-800 shadow-[0_0_50px_rgba(0,0,0,0.02)] z-20"
        >
          <div className="max-w-7xl mx-auto">
            <motion.div
              initial="hidden"
                    ...
                    >
                      <div className="w-full bg-white/95 backdrop-blur-md py-3.5 text-[10px] uppercase font-bold tracking-widest text-center text-stone-800 translate-y-4 group-hover:translate-y-0 transition-all duration-500 rounded-xl shadow-lg overflow-hidden relative z-0 group/btn">
                        ...
                        <span className="relative z-10 transition-colors duration-300 group-hover/btn:text-stone-950">
                          {t.signature.btnHover}
                        </span>
                      </div>
                    </Link>
                  </div>
                  <div className="text-center space-y-2 px-2 flex-grow flex flex-col justify-end">
                    <span className="text-[8px] md:text-[10px] text-stone-400 dark:text-stone-500 uppercase tracking-[0.2em] font-medium">
                      Unisex • {parfum.ukuran}
                    </span>
                    <h3
                      className={`${fontJudul.className} text-base md:text-xl text-stone-800 dark:text-stone-100 uppercase leading-snug line-clamp-1 group-hover:text-amber-800 dark:group-hover:text-amber-400 transition-colors`}
                    >
                      {parfum.nama}
                    </h3>
                    <p className="text-stone-600 dark:text-stone-400 font-medium text-[11px] md:text-sm tracking-wide">
          ...
          >
            {t.metrics.map((item, i) => (
              <motion.div key={i} variants={fadeInUp} className="group">
                <div
                  className={`${fontJudul.className} text-3xl md:text-4xl mb-2 text-stone-300 dark:text-stone-600 group-hover:text-stone-800 dark:group-hover:text-stone-100 transition-colors duration-500`}
                >
                  {item.title}
                </div>
        ...
        >
          ...
          <div className="max-w-6xl mx-auto text-center relative z-10">
            ...
            >
              <h2
                className={`${fontJudul.className} text-3xl md:text-5xl italic leading-tight text-stone-100 font-light whitespace-pre-line`}
              >
                {t.testimonial.quote}
              </h2>
            </motion.div>
        ...
        <motion.footer
          ...
          className="relative z-20 bg-white dark:bg-stone-900 pt-20 pb-10 px-6 md:px-8 border-t border-stone-100 dark:border-stone-800"
        >
          <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-12 gap-12 mb-16">
            <div className="md:col-span-5">
              <h2
                className={`${fontJudul.className} text-3xl mb-5 tracking-widest text-stone-900 dark:text-stone-100`}
              >
                EVOMI
              </h2>
            ...
            <div className="md:col-span-3">
              <h4 className="font-bold text-[11px] uppercase tracking-widest mb-6 text-stone-800 dark:text-stone-200">
                {t.footer.contact}
              </h4>
            ...
            <div className="md:col-span-4">
              ...
              <p className="text-stone-400 dark:text-stone-500 text-xs mb-4">
              ...
              <div className="flex border-b border-stone-300 dark:border-stone-700 pb-2 focus-within:border-stone-900 dark:focus-within:border-stone-400 transition-colors">
                <input
                  ...
                  className="bg-transparent w-full text-sm outline-none text-stone-800 dark:text-stone-200 placeholder-stone-400 dark:placeholder-stone-600"
                />
                <button className="text-[10px] uppercase font-bold text-stone-800 dark:text-stone-200 hover:text-amber-800 dark:hover:text-amber-400 transition-colors tracking-wider">
                  {t.footer.subscribe}
                </button>
              </div>
            </div>
